...
| `quality-dashboard.html` | Interactive dashboard reading the data-quality-report JSON snapshots — At-a-Glance tiles, multi-week trend charts, sortable/searchable field and impact-score tables, tabbed integrity browser. Linked from index.html's header. |
