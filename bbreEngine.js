...
// Canonical 24-tone vocabulary (Session 16) — see CLAUDE.md's "Canonical Tone
// Vocabulary" section. Replaces the old 39-tag free-for-all and the previous
// 12-word/34-word vocabularies that disagreed with it; every book's real
// `tones[]` now uses only these 24, and this map is the fallback for any
// future book that arrives without one.
const THEME_TONES_MAP = {
  'thriller':             ['propulsive', 'tense'],
  'domestic suspense':    ['twisty', 'dark', 'tense'],
  ...
  'romance':              ['heartwarming', 'propulsive'],
  'historical':           ['atmospheric', 'slow-burn'],
  'sci-fi':               ['atmospheric', 'propulsive'],
  'speculative':          ['atmospheric', 'slow-burn'],
  'suspense':             ['tense', 'propulsive'],
  'high-concept':         ['propulsive', 'twisty'],
  'adventure':            ['propulsive', 'inspiring'],
  'ya':                   ['propulsive', 'character-driven'],
  'biography':            ['character-driven', 'inspiring'],
  'history':              ['revelatory', 'dense'],
  'military':             ['gritty', 'dense'],
  'business':             ['dense', 'investigative'],
  'tech history':         ['investigative', 'revelatory'],
  'finance':              ['dense', 'investigative'],
  'sports':               ['inspiring', 'character-driven'],
  'food':                 ['conversational', 'poignant'],
  'psychology':           ['thoughtful', 'dense'],
  'political':            ['dense', 'investigative'],
  'social commentary':    ['thoughtful', 'satirical'],
  'music history':        ['character-driven', 'inspiring'],
  'spy':                  ['tense', 'twisty'],
  'humor':                ['funny', 'satirical'],
  'comedy':               ['funny'],
};

const TONE_PRIORITY = [
  'compulsive', 'twisty', 'propulsive', 'procedural', 'slow-burn', 'nonlinear', 'ensemble',
  'tense', 'dark', 'bleak', 'gritty',
  'heartwarming', 'poignant', 'inspiring', 'funny', 'satirical',
  'character-driven', 'atmospheric', 'lyrical', 'conversational',
  'revelatory', 'thoughtful', 'dense', 'investigative',
];
