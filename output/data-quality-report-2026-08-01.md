...
- Integrity count changes: brokenNearMiss -52, brokenOrphaned -456, similarOutOfRange -4
...
2. **Duplicate book entries** (−0.5 pts)
...
**Current** — projected score: 89/100


**Phase 1 — Quick data-entry fixes** — projected score: 91/100 (+2 from current)
...
**Phase 2 — Add the top 30 missing books** — projected score: 91/100 (+2 from current)
...
**Phase 3 — Add the next-tier missing books (top 100)** — projected score: 91/100 (+2 from current)
...
**Phase 4 — Automation catch-up + targeted backfills** — projected score: 95/100 (+6 from current)
...
**Theoretical ceiling (literal 100)** — projected score: 100/100 (+11 from current)
