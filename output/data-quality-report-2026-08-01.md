...
1. **Orphaned similarToTitles references** (−14.9 pts)
   382 reference(s) with no close match anywhere in the dataset — mostly legitimate citations to books never added, but at this volume (8.6% of all citations) it's a real completeness gap on the similarToTitles signal, not nothing.
...
3. **Broken similarToTitles references (candidate-to-candidate)** (−5.9 pts)
...
**Current** — projected score: 68/100


**Phase 1 — Quick data-entry fixes** — projected score: 76/100 (+8 from current)
...
**Phase 2 — Add the top 30 missing books** — projected score: 80/100 (+12 from current)
...
**Phase 3 — Add the next-tier missing books (top 100)** — projected score: 83/100 (+15 from current)
...
**Phase 4 — Automation catch-up + targeted backfills** — projected score: 88/100 (+20 from current)
...
**Theoretical ceiling (literal 100)** — projected score: 100/100 (+32 from current)
